...
exports.genericConfig = {
    ...
    resolve: {
        ...
        alias: Object.assign(Object.assign(Object.assign(Object.assign({}, getAliasFor("yasgui")), getAliasFor("yasr")), getAliasFor("yasqe")), getAliasFor("utils")),
        extensions: [".json", ".js", ".ts", ".scss"],
    },
    plugins: plugins,
};
const config = Object.assign(Object.assign({}, exports.genericConfig), { stats: {
        errorDetails: true,
        children: true,
    }, output: {
